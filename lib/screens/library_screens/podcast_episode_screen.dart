...
class PEpisodeScreen extends StatefulWidget {
  @override
  _PEpisodeScreenState createState() => _PEpisodeScreenState();
}

class _PEpisodeScreenState extends State<PEpisodeScreen> {
  List<String> items;
