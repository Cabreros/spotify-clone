...
class PDownloadScreen extends StatefulWidget {
  @override
  _PDownloadScreenState createState() => _PDownloadScreenState();
}

class _PDownloadScreenState extends State<PDownloadScreen> {
  List<String> items;
