...
class MPlaylistScreen extends StatefulWidget {
  @override
  _MPlaylistScreenState createState() => _MPlaylistScreenState();
}

class _MPlaylistScreenState extends State<MPlaylistScreen> {
  List<String> items;
